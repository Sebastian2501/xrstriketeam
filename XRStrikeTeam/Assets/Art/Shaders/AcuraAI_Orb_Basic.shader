...
Shader "AcuraAI_Orb_Basic"
{
	Properties
	{
		...
		_T3D_Refl("T3D_Refl", CUBE) = "white" {}
		_T2D_N_a("T2D_N_a", 2D) = "bump" {}
		_T2D_N_b("T2D_N_b", 2D) = "bump" {}
	...
	SubShader
	{
		...
		uniform sampler2D _T2D_N_a;
		uniform float _Speed_A;
		uniform sampler2D _T2D_N_b;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 lerpResult40 = lerp( BlendNormals( UnpackNormal( tex2D( _T2D_N_a, panner17 ) ) , UnpackNormal( tex2D( _T2D_N_b, panner19 ) ) ) , float3(0,0,1) , _Normal_Power);
			...
			float3 linearToGamma43 = LinearToGammaSpace( texCUBE( _T3D_Refl, appendResult29 ).rgb );
			...
			float3 lerpResult31 = lerp( lerpResult11 , ( linearToGamma43 + lerpResult11 ) , saturate( fresnelNode32 ));
			o.Albedo = ( lerpResult31 + tex2DNode10.g );
...
Node;AmplifyShaderEditor.RangedFloatNode;44;343.668,422.4474;Inherit;False;Property;_Alpha;Alpha;12;0;Create;True;0;0;0;False;0;False;0.47;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;45;312.3224,323.02;Inherit;False;Property;_Smoothness;Smoothness;13;0;Create;True;0;0;0;False;0;False;0.8;0;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=3058E146305F182EA2FE5E04BD6C78B07FD10FB9